...
(() => {
  const pendingArtwork = 'assets/pirate-mask/pending.webp';
  window.SLOT_GAME_CONFIG = {
    schemaVersion: 1,
    id: 'pirate',
    assets: {
      frame: { portrait: 'assets/pirate-mask/frame.webp', fallback: 'assets/pirate-mask/frame.webp' },
      loading: 'assets/pirate-mask/frame.webp',
  ...
  rules: {
    ...
    ui: {
      name: 'Máscara pirata · Símbolos pendientes',
      numberLocale: 'es-AR',
      scatterPaytableLabel: '{label} · APUESTA total',
      freeSpinsSuffix: 'giros',
      paytableMultiplierSuffix: '×',
      announcementAlt: 'Panel de la máscara pirata',
      frameAlt: 'Arte base de la máscara pirata',
      bigWinAlt: 'Premio grande',
      lowWinAlt: 'Premio',
      paytableBrand: 'PIRATA · EN PREPARACIÓN',
      ...
      spinLabel: 'Girar',
      menuLabel: 'PREMIOS',
      loadingLabel: 'Cargando máscara pirata',
      lowWinTitle: '¡PREMIO!',
